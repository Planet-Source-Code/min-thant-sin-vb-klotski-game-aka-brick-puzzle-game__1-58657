...
'///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
'*** NOTE : This version uses regions, and it often messes up your screen. (Try resizing the Form repeatedly and quickly)
'                 I've included this one for completeness. This one sucks.
'///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Private Sub picBoard_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If DiffX >= (BrickWidth \ MOUSE_SENSITIVITY) Then
        ...
        If NewMouseX > OldMouseX Then
            ...
            If boolCanMove Then
                ...
                If CurGID > 0 And CurGID <= UBound(Regions()) Then
                    Call OffsetRgn(Regions(CurGID), GridWidth, 0)
                End If
            End If
    ...
    If DiffY >= (BrickHeight \ MOUSE_SENSITIVITY) Then
        ...
        If NewMouseY > OldMouseY Then
            For i = 1 To CurrentList.Count
                ...
                If tmpBrick.YCoord >= (BoardDimX - 1) Then
                    boolCanMove = False
                    Exit For
                End If
            Next i
            ...
            If boolCanMove Then
                ...
                If CurGID > 0 And CurGID <= UBound(Regions()) Then
                    Call OffsetRgn(Regions(CurGID), 0, GridHeight)
                End If
            End If
    ...
    If CurGID > 0 And CurGID <= UBound(Regions()) Then
        ...
        Call FrameRgn(picBackBuffer.hdc, Regions(CurGID), hBrush, BRUSH_WIDTH, BRUSH_HEIGHT)
        DeleteObject hBrush
    End If
...
Sub MoveBrick(ByVal d As ENUM_DIRECTION)
    ...
    For i = 1 To CurrentList.Count
        ...
        Set lb = GetBrick(tmpBrick.XCoord - 1, tmpBrick.YCoord)           'Left brick
        Set rb = GetBrick(tmpBrick.XCoord + 1, tmpBrick.YCoord)          'Right brick
        Set tb = GetBrick(tmpBrick.XCoord, tmpBrick.YCoord - 1)           'Top brick
        Set bb = GetBrick(tmpBrick.XCoord, tmpBrick.YCoord + 1)          'Bottom brick
        
        Set ltb = GetBrick(tmpBrick.XCoord - 1, tmpBrick.YCoord - 1)      'Left-top brick
        Set rtb = GetBrick(tmpBrick.XCoord + 1, tmpBrick.YCoord - 1)     'Right-top brick
        Set lbb = GetBrick(tmpBrick.XCoord - 1, tmpBrick.YCoord + 1)     'Left-bottom brick
        Set rbb = GetBrick(tmpBrick.XCoord + 1, tmpBrick.YCoord + 1)    'Right-bottom brick
